<div class="container">
	...
	<section id="niveis" class="paralla-section">
		<div class="container">
	        <div class="row">
	          <div class="col-lg-12 text-center">
	            <h1 class="section-heading"><br>Níveis do jogo</h1>
	...
	<section id="ciclos" class="paralla-section">
		<div class="container">
	        <div class="row">
	          <div class="col-lg-12 text-center">
	            <h1 class="section-heading"><br>Ciclos</h1>
	...
	<section id="conquistas" class="paralla-section">
		<div class="row">
			...
			<div class="col-md-6 col-sm-12">
				<img src="<?php echo base_url('/images/premio.png');?>" class="img-responsive" alt="about img 1">
			</div>
		</div>
	</section>
